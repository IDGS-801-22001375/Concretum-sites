...
from models import db, Venta, VentaDetalle, CorteCaja, CorteDesglose, Cliente, Productos
...
def ventas():
    ...
    prods    = Productos.query.filter_by(es_activo=1).order_by(Productos.nombre).all()
